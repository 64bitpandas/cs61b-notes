...
![The naive approach.](../.gitbook/assets/image.png)
...
![uwu inheritance is cool and good](<../.gitbook/assets/image (1).png>)
...
![A chart comparing the differences between the types of classes.](<../.gitbook/assets/image (2).png>)
