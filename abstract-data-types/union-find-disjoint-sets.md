...
![Calling union\(1,2\).](../.gitbook/assets/image%20%2835%29.png)
...
![Parents list.](../.gitbook/assets/image%20%2853%29.png)

Now, let's say we call `union(3,2)`. We can just set the parent of 3 to 2, as to create a structure like this:

![union\(1,2\) followed by union\(3,2\)](../.gitbook/assets/image%20%2860%29.png)
